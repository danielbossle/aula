...
faturamentosemgorjeta = 0
gorjeta = 0
quantidadetotal = 0
for (semgorjeta of receita) {
    if (semgorjeta.gorjeta > 0) {
        faturamentosemgorjeta +=receita[0].valor; 
        gorjeta +=receita[0].gorjeta;
        quantidadetotal ++
    }
}
console.log("O faturamento total sem gorjeta é de ", faturamentosemgorjeta)
console.log("Total de gorjetas é ", gorjeta)
console.log("A quantidade total de pedidos é ", quantidadetotal)
...
function legalAgeOrNot (age) {
    if (age >= 18){
        ...
        else {console.log("A idade e menor do que 18 anos, entrada não permitida")}
    }
